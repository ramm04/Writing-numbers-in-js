/* Рассмотрим стандартный объект Math, в котором есть ряд полезных функций,
 которые делают сложные вычисления */
 ...
 Math.round(3.2); // 3, математическое округление
 Math.round(3.5); // 4, математическое округление
